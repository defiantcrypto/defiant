...
const string strMessageMagic = "Defiant Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    {
        nSubsidy = 500000000 * COIN; //  DEFIANT
    }
...
#ifdef ENABLE_WALLET
// defiant: attempt to generate suitable proof-of-stake
