...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeDefiantAmount"))
        settings.setValue("nAnonymizeDefiantAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeDefiantAmount = settings.value("nAnonymizeDefiantAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeDefiantAmount"))
        SoftSetArg("-anonymizeDefiantamount", settings.value("nAnonymizeDefiantAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeDefiantAmount:
            nAnonymizeDefiantAmount = value.toInt();
            settings.setValue("nAnonymizeDefiantAmount", nAnonymizeDefiantAmount);
            emit anonymizeDefiantAmountChanged(nAnonymizeDefiantAmount);
            break;
        default:
            break;
        }
